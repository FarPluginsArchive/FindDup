...
function MD5Buffer(const Buffer; Size: LongInt): TMD5Digest;
...
procedure MD5_memset(Output: PByteArray; Value: LongInt; Len: LongWord);
begin
...
var
 ...
 Size: TFileSize;
 ReadBytes : LongWord{TFileSize};
 TotalBytes : TFileSize;
 SavePos: TFileSize;
begin
 MD5Init(Context);
 Size:=Stream.Size;
